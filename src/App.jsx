                ...
                <div style={{ flexShrink:0, marginLeft:"40px" }}>
                  {profile.photoURL
                    ? <img src={profile.photoURL} alt="Profile" crossOrigin="anonymous"
                        style={{ width:"200px", height:"200px", minWidth:"200px", minHeight:"200px", borderRadius:"12px", objectFit:"cover", border:"2px solid rgba(212,175,55,0.4)", boxShadow:"0 8px 32px rgba(0,0,0,0.5)", display:"block" }}
                      />
                ...
                <div style={{ padding:"24px 28px", background:"linear-gradient(135deg,rgba(212,175,55,0.1),rgba(212,175,55,0.03))", border:"1px solid rgba(212,175,55,0.25)", borderRadius:"8px", marginBottom:"20px", display:"flex", alignItems:"center", gap:"20px" }} className="fade-up-2">
                  ...
                  <div style={{ flexShrink:0, textAlign:"center" }}>
                    ...
                    <label htmlFor="photo-upload" style={{ cursor:"pointer", display:"block" }}>
                      {profile.photoURL
                        ? <img src={profile.photoURL} crossOrigin="anonymous" alt="Profile" style={{ width:"200px", height:"200px", minWidth:"200px", minHeight:"200px", borderRadius:"12px", objectFit:"cover", border:"2px solid rgba(212,175,55,0.4)", boxShadow:"0 4px 16px rgba(0,0,0,0.3)", display:"block" }} />
